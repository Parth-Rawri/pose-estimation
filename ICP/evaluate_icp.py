...
parser.add_argument('--val', action='store_true', help='evaluate validation set')
parser.add_argument('--test', action='store_true', help='evaluate test set')
...
def main():
    ...
    elif not args.val or args.test:
    ...
    for pose_dir in list_pose_dir:
        ...
        for scene_id in range(5):
            for obj_id in range(1, 6):
                ...
                average_closest_point[obj_id - 1].append(evaluate(LIST_OBJ_FOLDERNAME[obj_id - 1], pred_pose, gt_pose))
